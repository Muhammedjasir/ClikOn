...
public class TechnicianPickupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_technician_pickup, container, false);
        ...
        getConsumerDeliveryNotifications();
        getShopDeliveryNotifications();
    ...
    private void getConsumerDeliveryNotifications() {
        try {
            ...
            String condition = "SELECT DISTINCT CTI_CM_DOC_NO,CTI_CUSTOMER_NAME,CTI_AREA_CODE,CTI_CNSMR_ADDRSS,CTI_CUSTOMER_MOBILE" +
                    " FROM OT_CLCTN_ITEMS WHERE CTI_STS_CODE='DRDASN' AND CTI_SHP_CONS_UNIT = 'CONSUMER' " +
